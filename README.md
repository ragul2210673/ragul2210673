...
| :--- | :--- | :--- |
| **E-Commerce Microservices Platform** | Designed a scalable **5-module backend architecture**. Implemented RESTful APIs for high-volume transactions, integrated **Redis caching** for performance, and utilized **Prometheus** for system observability (improving stability by 40%). | *Java, Spring Boot, Docker, Redis, SQL* |
| **[Voice-Assisted Tamil App](https://github.com/ragul2210673/tamil-pronunciation-app)** | A mobile application providing AI-driven feedback on Tamil pronunciation. Integrates a **Python backend** for real-time logic and viseme animations. | *Flutter, FastAPI, Python, Azure Cognitive Services* |
